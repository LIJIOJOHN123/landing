...
import logo6 from "../assets/Login/logo6.png"
import logo7 from "../assets/Login/logo7.png"
      ...
      <Row className="align-items-center">
        <Col md={4} className="me-5">
          ...
          <p className="text-center">
            Log in to ChargebackZero AI to continue to your dashboard.
          </p>
          ...
          <Button className="w-100 pt-3 mb-2 bg-white   border-black text-start ">
